...
printTest(String ip) async {
  ...
  try {
    ...
    print('connecting');
    final PosPrintResult res = await printerService.connect(ip,
        port: 9100, timeout: Duration(seconds: 10));
    if (res == PosPrintResult.success) {
      ...
      Uint8List? tableHeaderAs8List = await createImageFromWidget(tableHeader(),
          logicalSize: const Size(500, 500), imageSize: Size(680, 680));
